...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.siteHeader = (0, _jquery2.default)("");
		this.headerTriggerElement = (0, _jquery2.default)("");
		this.createHeaderWaypoint();
		this.pageSections = (0, _jquery2.default)("");
		this.headerLinks = (0, _jquery2.default)("");
				...
				new Waypoint({
					...
					handler: function handler(direction) {
						if (direction == "down") {
							...
							(0, _jquery2.default)(matchingHeaderLink).addClass("");
						}
					},
					offset: "18%"
				});
